    ...
    <div className="space-y-4 animate-in fade-in duration-150">
      <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm">
        ...
        <div className="grid grid-cols-7 gap-1 text-center text-xs font-bold text-slate-400 mb-2">
          ...
          <span>J</span>
          <span>V</span>
          <span className="text-[#076A9F]">S</span>
          <span className="text-[#076A9F]">D</span>
        </div>
            ...
            return (
              <button
                ...
                className={`h-11 rounded-xl flex flex-col items-center justify-center relative transition font-medium text-xs ${
                  isSelected
                    ? 'bg-[#076A9F] text-white font-bold shadow-md shadow-sky-500/30 scale-105 z-10'
                    : hasMatch
                    ? 'bg-sky-50 text-[#076A9F] font-bold border border-sky-200 hover:bg-sky-100'
        ...
        <div className="flex items-center justify-center gap-4 mt-4 pt-3 border-t border-slate-100 text-[11px] text-slate-500">
          <span className="flex items-center gap-1.5">
            <span className="w-2 h-2 rounded-full bg-[#076A9F]"></span> Con Partido FCV
          </span>
          <span className="flex items-center gap-1.5">
        ...
        {INITIAL_MATCHES[selectedDate] ? (
          INITIAL_MATCHES[selectedDate].map((partido) => (
            <div 
              ...
              className="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm hover:border-[#076A9F] transition cursor-pointer space-y-3"
            >
              ...
              <div>
                <span className="text-xs font-semibold text-[#076A9F] uppercase tracking-wider">
                  {partido.categoria}
                </span>
              ...
              <div className="flex items-center justify-between text-xs text-slate-600 pt-2 border-t border-slate-100">
                ...
                <span className="text-[#076A9F] font-bold hover:underline">
                  Ver detalle →
                </span>
              </div>
            </div>
